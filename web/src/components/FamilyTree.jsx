...
export default function FamilyTree() {
  ...
  return (
    ...
    >
      ...
      <div className={`fixed left-1/2 transform -translate-x-1/2 z-30 select-none w-[90%] sm:w-auto transition-all duration-300 ${isMinimalMode ? 'opacity-0 pointer-events-none -translate-y-4' : 'opacity-100 pointer-events-none'}`} style={{ top: 'calc(env(safe-area-inset-top, 0px) + 0.75rem)' }}>
      ...
      <div className={`fixed left-4 sm:bottom-auto sm:top-6 sm:left-8 z-30 pointer-events-none select-none transition-all duration-300 ${isMinimalMode ? 'opacity-0 pointer-events-none' : 'opacity-100'}`} style={{ bottom: 'calc(env(safe-area-inset-bottom, 0px) + 1rem)' }}>
      ...
      <div className={`fixed right-4 sm:bottom-auto sm:top-6 sm:right-8 z-30 flex items-center gap-2 transition-all duration-300 ${isMinimalMode ? 'opacity-0 pointer-events-none' : 'opacity-100'}`} style={{ bottom: 'calc(env(safe-area-inset-bottom, 0px) + 1rem)' }}>
        <button
